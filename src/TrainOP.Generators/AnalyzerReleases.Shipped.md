...
TOP006 | TrainOP.Generators | Warning | Value tuple uses default ItemN (no explicit name and no inference); elements allocate as new ItemN wagons after omitted inputs unload
