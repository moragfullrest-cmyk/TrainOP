    ...
    internal static class RouteOriginWindow
    {
            ...
            out ExpressionSyntax assignmentRhs)
        {
            ...
            if (node is ArgumentSyntax argument
                && RouteOriginClassifier.TryGetOutArgumentLocal(argument, semanticModel, out var outLocal)
            ...
            if (node is AssignmentExpressionSyntax deconstructAssignment
                && RouteOriginClassifier.TryGetTupleDeconstructOriginAssignment(
            ...
            return RouteOriginClassifier.TryGetPatternOriginAssignment(
                node,
                localSymbol,
                semanticModel,
                out originExpression,
            ...
            out ExpressionSyntax assignmentRhs)
        {
            ...
            return RouteOriginClassifier.TryClassifyRhsOrigin(
