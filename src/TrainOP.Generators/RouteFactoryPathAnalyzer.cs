...
namespace TrainOP.Generators
{
    ...
    internal static class RouteFactoryPathAnalyzer
    {
            ...
            out InvocationExpressionSyntax firstDownstreamStation)
        {
            ...
            var current = ReceiverExpressionPeel.UnwrapTransparent(endpoint);
            ...
            while (true)
            {
                ...
                if (IsForkingExpression(ReceiverExpressionPeel.UnwrapTransparent(receiver)))
                {
        ...
        private static FactoryPathSimulation SimulateReturnExpression(
            ...
            Location location)
        {
            if (ChainDetector.TryBuildChainEndingAt(expression, semanticModel, out var chain))
            {
            ...
            if (ChainDetector.TryBuildFactoryExtensionChain(
                expression,
                semanticModel,
                compilation,
