...
namespace TrainOP.Generators
{
    ...
    internal static class BranchRouteJoinValidator
    {
        ...
        /// </summary>
        public static BranchRouteJoinValidation Validate(BranchRouteJoinSet joinSet)
        {
            if (joinSet == null)
            {
                return Fail(
            ...
            var stationName = GetDownstreamStationName(joinSet.DownstreamStation);
        ...
        /// <summary>
        /// Reads the station name string literal from argument 0, or returns <c>?</c>.
        /// </summary>
        internal static string GetDownstreamStationName(InvocationExpressionSyntax downstreamStation)
        {
