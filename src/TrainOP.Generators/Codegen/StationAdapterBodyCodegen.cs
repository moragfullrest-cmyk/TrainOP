...
namespace TrainOP.Generators
{
    ...
    /// </summary>
    internal static class StationAdapterBodyCodegen
    {
        /// <summary>
        ...
        /// <summary>
        /// Options that differ between canonical and chain-binding adapters.
        /// </summary>
        ...
        public static string GetStationReturnTypeDisplay(StationHandlerBinding schema)
        {
            ...
            return HandlerFuncTypeCodegen.ResolveCanonicalFuncReturnType(schema);
        }
