...
Срез: **2026-07-21** · версия в csproj: **0.11.0** · целевой статус сейчас: **NuGet Preview (0.x)**
...
| 2 | CHANGELOG с историей 0.1 → 0.11 | **80%** | `CHANGELOG.md` обновлён для 0.11.0; ранние версии кратко |
| 3 | Git-тег, согласованный с `Version` (например `v0.11.0`) | **50%** | Version=0.11.0 в csproj; теги `v0.1.0` / `v0.1.1` / `v0.6.0` (тег `v0.11.0` ещё не создан) |
