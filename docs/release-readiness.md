...
Срез: **2026-09-22** · версия в csproj: **0.16.0** · целевой статус сейчас: **NuGet Preview (0.x)**
...
| 2 | CHANGELOG с историей 0.1 → 0.16 | **92%** | `CHANGELOG.md` включает 0.16.0; ранние версии кратко |
| 3 | Git-тег, согласованный с `Version` | **90%** | Version=0.16.0; тег `v0.16.0` после merge в `master` |
